...
\begin{center}
  ...
  \begin{minipage}{0.92\textwidth}\small\raggedright
    ...
    \textsuperscript{*}Corresponding author. robin.geyer@charite.de,
  \end{minipage}
\end{center}
...
\begin{table*}[t]
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{3.5cm}>{\centering\arraybackslash}p{4.0cm}>{\centering\arraybackslash}p{4.0cm}>{\centering\arraybackslash}p{1.2cm}@{}}
    \toprule
...
\begin{thebibliography}{99}
  ...
  Wehrwein EA, Orer HS, Barman SM (2016) Overview of the anatomy, physiology, and pharmacology of the autonomic nervous system. Comprehensive physiology 6(3):1239--1278

  \bibitem{zygmunt2010methods}
  Zygmunt A, Stanczyk J (2010) Methods of evaluation of autonomic nervous system function. Archives of Medical Science 6(1):11--18

  \bibitem{budidha2019photoplethysmography}
  Budidha K, Kyriacou PA (2019) Photoplethysmography for quantitative assessment of sympathetic nerve activity (SNA) during cold stress. Frontiers in Physiology 9:1863

  \bibitem{ackermann2021commentary}
  Ackermann S, Laborde S, Borges U, Mosley E (2021) Commentary: Photoplethysmography for quantitative assessment of sympathetic nerve activity (SNA) during cold stress. Frontiers in Physiology 12:602745

  \bibitem{richardson2024receiver}
  Richardson E, Trevizani R, Greenbaum JA, et~al (2024) The receiver operating characteristic curve accurately assesses imbalanced datasets. Patterns 5(6)
